...
fetal_health_model.save('Model_11.h5')
model_11_pred = fetal_health_model.predict(X_test_norm)

print(classification_report(y_test, tf.argmax(model_11_pred, axis = 1), target_names=classes_names))
...
create_confusion_matrix(y_test, tf.argmax(model_11_pred, axis = 1), classes = classes_names, figsize = (15, 15), text_size = 15)
plt.show()
