...
fetal_health_model = tf.keras.Sequential([
    tf.keras.layers.Dense(8, activation = 'tanh', kernel_regularizer = tf.keras.regularizers.L2(0.003)),
    tf.keras.layers.Dense(4, activation = 'tanh', kernel_regularizer = tf.keras.regularizers.L2(0.003)),
...
fetal_health_model.save('Model_6.h5')