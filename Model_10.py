...
model_10_pred = fetal_health_model.predict(X_test_norm)
fetal_health_model.save("Model_10.h5")
print(classification_report(y_test, tf.argmax(model_10_pred, axis = 1), target_names=classes_names))
...
create_confusion_matrix(y_test, tf.argmax(model_10_pred, axis = 1), classes = classes_names, figsize = (15, 15), text_size = 15)
plt.show()
